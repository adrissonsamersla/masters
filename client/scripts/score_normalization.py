# Inspired from: https://github.com/DLR-RM/rl-baselines3-zoo/blob/master/rl_zoo3/plots/score_normalization.py
...
reference_scores = [
    ...
    ReferenceScore("Walker2DBulletEnv-v0", 200, 2500),
    # Custom Envs
    # ReferenceScore("SmallSizeLeague-v1", -1, 1),
    # ReferenceScore("SmallSizeLeague-v2", -1, 1),
    ReferenceScore("SmallSizeLeague-v1", -0.21522, -0.12687),
    ReferenceScore("SmallSizeLeague-v2", -0.19773, -0.02868),
    # ReferenceScore("SmallSizeLeague-v1", -1, -0.12687),
    # ReferenceScore("SmallSizeLeague-v2", -1, -0.02868),
]
