# Inspired from: https://github.com/DLR-RM/rl-baselines3-zoo/blob/master/rl_zoo3/plots/all_plots.py
        ...
        for algo in args.algos:
            for folder_idx, exp_folder in enumerate(args.exp_folders):
                ...
                if len(merged_results) > 0:
                    ...
                    if args.median:
                        results[env][f"{algo}-{args.labels[folder_idx]}"] = f"{np.median(last_evals):.5f}"
                    else:
                        results[env][
