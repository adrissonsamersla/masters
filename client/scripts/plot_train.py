# Inspired from: https://github.com/DLR-RM/rl-baselines3-zoo/blob/master/rl_zoo3/plots/plot_train.py
...
def plot_train():
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('./results/train_' + envs[0] + '_' + algo + '.eps', format='eps')
    plt.savefig('./results/train_' + envs[0] + '_' + algo + '.svg', format='svg')
    plt.savefig('./results/train_' + envs[0] + '_' + algo + '.png', format='png', dpi=400)
