# Inspired from: https://github.com/DLR-RM/rl-baselines3-zoo/blob/master/rl_zoo3/plots/plot_from_file.py
...
def plot_from_file():  # noqa: C901
    ...
    if not args.skip_timesteps:
        ...
        for env in envs:
            ...
            plt.tight_layout()
            plt.savefig("./results/timesteps.eps", format='eps')
            plt.savefig("./results/timesteps.svg", format='svg')
            plt.savefig("./results/timesteps.png", format='png', dpi=400)
    ...
    for key in keys:
        ...
        for env in envs:
            ...
            if env in env_ids:
                algo_scores[-1] = normalize_score(algo_scores[-1], env)
                if not skip_all_algos_dict:
                    all_algo_scores[-1] = normalize_score(all_algo_scores[-1], env)
            elif env not in env_ids and args.rliable:
    ...
    if args.rliable:
        ...
        plt.savefig("./results/metrics.eps", format='eps')
        plt.savefig("./results/metrics.svg", format='svg')
        plt.savefig("./results/metrics.png", format='png', dpi=400)
        ...
        plt.legend()
        plt.savefig("./results/profiles.eps", format='eps')
        plt.savefig("./results/profiles.svg", format='svg')
        plt.savefig("./results/profiles.png", format='png', dpi=400)
        ...
        if args.versus:
            ...
            plt.tight_layout()
            plt.savefig("./results/versus.eps", format='eps')
            plt.savefig("./results/versus.svg", format='svg')
            plt.savefig("./results/versus.png", format='png', dpi=400)
        ...
        if args.iqm:
            ...
            plt.legend()
            plt.tight_layout()
            plt.savefig("./results/iqm.eps", format='eps')
            plt.savefig("./results/iqm.svg", format='svg')
            plt.savefig("./results/iqm.png", format='png', dpi=400)
    ...
    plt.tight_layout()
    plt.savefig("./results/sensitivity.eps", format='eps')
    plt.savefig("./results/sensitivity.svg", format='svg')
    plt.savefig("./results/sensitivity.png", format='png', dpi=400)
    ...
    if args.boxplot:
        ...
        plt.tight_layout()
        plt.savefig("./results/sensitivity_boxplot.eps", format='eps')
        plt.savefig("./results/sensitivity_boxplot.svg", format='svg')
        plt.savefig("./results/sensitivity_boxplot.png", format='png', dpi=400)
